...
It helps keep your bones strong. People who have healthy levels of it may be less likely to get certain conditions, but more research is needed. Your body makes vitamin D when you’re in sunshine. It’s also in salmon, tuna, and fortified foods. If you’re low on vitamin D, your doctor may suggest a supplement. But several large studies show no benefits to otherwise healthy adults. And taking too much is bad for you.', 1);
...
Generally, experts advise 150 minutes of moderate physical activity per week or 30 minutes daily, five days per week. You can also meet your fitness goals by doing 75 minutes of vigorous physical activity or 25 minutes daily, three days per week.1', 2);

INSERT INTO posts (title, content, author_id)
VALUES ('What are the laws regarding steroids in Germany?', 'In Germany, the use and possession of anabolic steroids without a prescription is illegal. Anabolic steroids are classified as controlled substances, and their unauthorized use can lead to legal consequences. It''s important to consult with a medical professional or legal advisor for specific information regarding steroids in Germany.', 2);
...
Magnesium helps your body regulate its zinc levels, though it should be noted that high intake of zinc can be detrimental to magnesium absorption and reduce magnesium balance - it will only hinder absorption when taken in abnormally high doses (around 142 mg of zinc per day).', 4);
...
-- exercises
INSERT INTO exercises (`exercise_name`, `instructions`)
